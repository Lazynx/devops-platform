...
EOH
      ...
      config {
        ...
        args = [
          "-c",
          "cd /Users/Lazynx/VSC/kbtu/devops-platform/services/project-service && uv run uvicorn project_service.app:get_app --factory --host 127.0.0.1 --port ${NOMAD_PORT_http} --reload"
        ]
      }

...
EOH
      ...
      config {
        ...
        args = [
          "-c",
          "cd /Users/Lazynx/VSC/kbtu/devops-platform/services/secrets-service && uv run alembic upgrade head"
        ]
      }

      env {
        PYTHONPATH = "/Users/Lazynx/VSC/kbtu/devops-platform/services/secrets-service/src"
      }

...
from auth_service.infrastructure.oauth.base_oauth_provider import BaseOAuthProvider
from auth_service.presentation.api.auth.schemas import OAuthUserInfo

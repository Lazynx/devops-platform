...
from auth_service.domain.entities import OAuthConnection, OAuthProvider, SessionData, User, UserRole
...
class GitHubOAuthLoginInteractor:
    ...
    async def __call__(self, dto: OAuthCallbackInputDTO) -> LoginResultDTO:
